...
export default class SimpleLangListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by SimpleLangParser#decl.
	enterDecl(ctx) {
	}

	// Exit a parse tree produced by SimpleLangParser#decl.
	exitDecl(ctx) {
	}
